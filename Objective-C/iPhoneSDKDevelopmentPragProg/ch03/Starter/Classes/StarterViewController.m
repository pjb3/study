...
- (void) viewWillAppear:(BOOL)animatedFlag {
  if(nil != editorViewController.messageInputField.text &&
     [editorViewController.messageInputField.text length] > 0) {
    messageLabel.text = editorViewController.messageInputField.text;
  }
}
